    ...
    >
      ...
      <div className="lg:h-[95vh] py-20 px-10 flex flex-col lg:flex-row items-center justify-between mt-5">
        <article className="w-full lg:w-1/2 flex flex-col items-center mb-10 lg:mb-0">
          ...
          />
          <h4 className="mt-5 mb-2 text-white text-4xl lg:text-3xl font-oxanium">Lucas Pereira</h4>
          <SocialLinks />
        </article>
        <article className="w-full lg:w-1/2">
          <TitleSection title="Sobre" />
          <h3 className="font-bold text-white text-4xl lg:text-md mt-20 mb-5">
            Conheça um pouco sobre mim
          </h3>
          <p className="text-3xl lg:text-md w-full lg:w-9/12 font-thin text-white mb-2">
          ...
          <p className="text-3xl lg:text-md w-full lg:w-9/12 font-thin text-white">
